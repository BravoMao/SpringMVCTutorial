...
import com.jianli.Configuration.StatelessCSRFApplication;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(classes = StatelessCSRFApplication.class)
@WebAppConfiguration
...
public class StatelessCSRFIntegrationTest {
    ...
    private ResponseEntity<String> http(final HttpMethod method, final String path, HttpHeaders headers) {
        ...
        return restTemplate.exchange("http://localhost:8080/" + path, method, testRequest, String.class);
    }
